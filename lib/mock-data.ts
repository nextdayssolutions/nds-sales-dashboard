...
export const CUSTOMERS: Customer[] = [
  // 田中 誠司 (id 1) - 6社
  { id: 101, ownerId: 1, name: "株式会社テックフロンティア", industry: "IT", contact: "山田 太郎", products: ["SFA Pro", "MA Basic"], relation: 8, lastContact: "2026-04-15", revenue: 2400000, status: "既存", memo: "定例MTG 月1回、キーパーソンは情シス部長" },
  { id: 102, ownerId: 1, name: "グローバルネット株式会社", industry: "通信", contact: "佐藤 花子", products: ["ERP Suite"], relation: 6, lastContact: "2026-04-10", revenue: 5800000, status: "既存", memo: "更新交渉中（6月締め）" },
  { id: 103, ownerId: 1, name: "ファーストリテール株式会社", industry: "小売", contact: "鈴木 一郎", products: ["POS Cloud"], relation: 4, lastContact: "2026-03-28", revenue: 1200000, status: "商談中" },
  { id: 104, ownerId: 1, name: "メディカルソリューション株式会社", industry: "医療", contact: "高橋 美咲", products: ["SFA Pro", "CRM Light"], relation: 9, lastContact: "2026-04-17", revenue: 3600000, status: "既存" },
  ...
  { id: 106, ownerId: 1, name: "フィンテック株式会社", industry: "金融", contact: "伊藤 由紀", products: ["ERP Suite", "MA Basic"], relation: 7, lastContact: "2026-04-12", revenue: 4200000, status: "既存" },

  // 山田 優子 (id 2, manager) - 6社
  { id: 201, ownerId: 2, name: "東亜商事株式会社", industry: "商社", contact: "岡田 秀樹", products: ["ERP Suite", "SFA Pro"], relation: 9, lastContact: "2026-04-18", revenue: 8500000, status: "既存" },
  { id: 202, ownerId: 2, name: "日本マニュファクチャリング", industry: "製造", contact: "西村 聡", products: ["ERP Suite", "MA Basic", "CRM Light"], relation: 10, lastContact: "2026-04-17", revenue: 12000000, status: "既存" },
  { id: 203, ownerId: 2, name: "グリーンロジスティクス", industry: "物流", contact: "古川 直子", products: ["SFA Pro"], relation: 8, lastContact: "2026-04-14", revenue: 6400000, status: "既存" },
  ...
  { id: 205, ownerId: 2, name: "パシフィック食品株式会社", industry: "食品", contact: "三浦 裕子", products: ["POS Cloud", "CRM Light"], relation: 7, lastContact: "2026-04-11", revenue: 5200000, status: "既存" },
  { id: 206, ownerId: 2, name: "リテールネクスト", industry: "小売", contact: "加藤 健", products: [], relation: 3, lastContact: "2026-03-30", revenue: 0, status: "見込み" },

  // 佐藤 健太 (id 3) - 6社
  { id: 301, ownerId: 3, name: "中央観光株式会社", industry: "観光", contact: "石川 真理", products: ["SFA Pro"], relation: 7, lastContact: "2026-04-16", revenue: 3800000, status: "既存" },
  { id: 302, ownerId: 3, name: "ミライエネルギー株式会社", industry: "エネルギー", contact: "森田 康介", products: ["ERP Suite"], relation: 8, lastContact: "2026-04-15", revenue: 7200000, status: "既存" },
  ...
  { id: 304, ownerId: 3, name: "ヘルスケアプラス", industry: "医療", contact: "長谷川 翔太", products: ["CRM Light"], relation: 7, lastContact: "2026-04-13", revenue: 4000000, status: "既存" },
  ...
  // 高橋 翔 (id 5) - 6社
  { id: 501, ownerId: 5, name: "ユニバーサルテック", industry: "IT", contact: "川村 美智子", products: ["SFA Pro", "MA Basic"], relation: 8, lastContact: "2026-04-17", revenue: 5100000, status: "既存" },
  { id: 502, ownerId: 5, name: "NorthAsia Holdings", industry: "商社", contact: "井上 哲也", products: ["ERP Suite"], relation: 9, lastContact: "2026-04-16", revenue: 6800000, status: "既存" },
  ...
  { id: 504, ownerId: 5, name: "イースト不動産", industry: "不動産", contact: "佐々木 亮", products: ["CRM Light"], relation: 7, lastContact: "2026-04-14", revenue: 3200000, status: "既存" },
  { id: 505, ownerId: 5, name: "関西フードサービス", industry: "食品", contact: "山口 美和", products: ["POS Cloud"], relation: 6, lastContact: "2026-04-09", revenue: 3600000, status: "既存" },
  ...
  { id: 701, ownerId: 7, name: "新宿リサーチ", industry: "調査", contact: "橋本 翼", products: ["SFA Pro"], relation: 5, lastContact: "2026-03-20", revenue: 1400000, status: "既存" },
...
export const PRODUCTS = ["SFA Pro", "MA Basic", "ERP Suite", "POS Cloud", "CRM Light"];
